...
from databuilder.extractor.redshift_table_usage_extractor import RedshiftTableUsagextractor
...
def run_redshift_table_usage_job():
    ...
    job_config = ConfigFactory.from_dict({
        f'extractor.redshift_metadata.{RedshiftTableUsagextractor.WHERE_CLAUSE_SUFFIX_KEY}': where_clause_suffix,
        f'extractor.redshift_metadata.{RedshiftTableUsagextractor.USE_CATALOG_AS_CLUSTER_NAME}': True,
    ...
    job = DefaultJob(conf=job_config,
                     task=DefaultTask(extractor=RedshiftTableUsagextractor(), loader=FsNeo4jCSVLoader()),
...
if __name__ == "__main__":
    ...
    run_redshift_table_usage_job().launch()
