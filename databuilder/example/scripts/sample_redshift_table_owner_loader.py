...
from databuilder.extractor.redshift_table_owner_extractor import RedshiftTableOwnerextractor
...
def run_redshift_table_owner_job():
    ...
    job_config = ConfigFactory.from_dict({
        f'extractor.redshift_metadata.{RedshiftTableOwnerextractor.WHERE_CLAUSE_SUFFIX_KEY}': where_clause_suffix,
        f'extractor.redshift_metadata.{RedshiftTableOwnerextractor.USE_CATALOG_AS_CLUSTER_NAME}': True,
    ...
    job = DefaultJob(conf=job_config,
                     task=DefaultTask(extractor=RedshiftTableOwnerextractor(), loader=FsNeo4jCSVLoader()),
...
if __name__ == "__main__":
    ...
    run_redshift_table_owner_job().launch()
