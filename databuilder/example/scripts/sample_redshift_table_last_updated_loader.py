...
def run_redshift_table_last_updated_job():
    ...
    tmp_folder = '/var/tmp/amundsen/table_last_updated'
    node_files_folder = f'{tmp_folder}/nodes/'
    relationship_files_folder = f'{tmp_folder}/relationships/'

    job_config = ConfigFactory.from_dict({
        f'extractor.redshift_metadata.{RedshiftTableLastUpdatedExtractor.WHERE_CLAUSE_SUFFIX_KEY}': where_clause_suffix,
        f'extractor.redshift_metadata.{RedshiftTableLastUpdatedExtractor.USE_CATALOG_AS_CLUSTER_NAME}': True,
    ...
    job = DefaultJob(conf=job_config,
                     task=DefaultTask(extractor=RedshiftTableLastUpdatedExtractor(), loader=FsNeo4jCSVLoader()),
...
if __name__ == "__main__":
    ...
    run_redshift_table_last_updated_job().launch()
