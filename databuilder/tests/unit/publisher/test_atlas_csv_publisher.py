...
class TestAtlasCsvPublisher(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._resource_path = os.path.join(os.path.dirname(__file__), f'../resources/atlas_csv_publisher')
        self.mock_atlas_client = MagicMock()

        config_dict = {'publisher.atlas_csv_publisher.entity_files_directory':  f'{self._resource_path}/entities',
    ...
    def test_publisher(self) -> None:
        ...
        publisher.init(conf=Scoped.get_scoped_conf(conf=self._conf,
