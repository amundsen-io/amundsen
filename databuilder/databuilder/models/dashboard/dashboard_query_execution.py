...
class DashboardQueryExecution(GraphSerializable, TableSerializable, AtlasSerializable):
    """
    A model that encapsulate Dashboard's Query execution timestamp in epoch and execution state
    """
    ...
    def _create_node_iterator(self) -> Iterator[GraphNode]:
        node = GraphNode(
            ...
            label=DashboardQueryExecution.DASHBOARD_QUERY_EXECUTION_LABEL,
            attributes={
    ...
    def _create_relation_iterator(self) -> Iterator[GraphRelationship]:
        relationship = GraphRelationship(
            ...
            end_label=DashboardQueryExecution.DASHBOARD_QUERY_EXECUTION_LABEL,
            end_key=self._get_last_execution_node_key(),
            type=DashboardQueryExecution.DASHBOARD_QUERY_EXECUTION_RELATION_TYPE,
            reverse_type=DashboardQueryExecution.EXECUTION_DASHBOARD_QUERY_RELATION_TYPE,
            attributes={}
        )
        yield relationship
    ...
    def _create_record_iterator(self) -> Iterator[RDSModel]:
        yield RDSDashboardExecution(
            ...
            timestamp=self._execution_timestamp,
            state=self._execution_state,
            dashboard_rk=DashboardQuery.DASHBOARD_QUERY_KEY_FORMAT.format(
                product=self._product,
                cluster=self._cluster,
                dashboard_group_id=self._dashboard_group_id,
                dashboard_id=self._dashboard_id,
    ...
    def _get_last_execution_node_key(self) -> str:
        return DashboardQueryExecution.DASHBOARD_QUERY_EXECUTION_KEY_FORMAT.format(
            product=self._product,
            cluster=self._cluster,
            dashboard_group_id=self._dashboard_group_id,
            dashboard_id=self._dashboard_id,
    ...
    def __repr__(self) -> str:
        return f'DashboardQueryExecution({self._dashboard_group_id!r}, {self._dashboard_id!r}, {self._query_id!r}, ' \
