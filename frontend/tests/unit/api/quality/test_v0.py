...
class QualityTest(unittest.TestCase):
    ...
    @unittest.mock.patch(quality_client_class_name + '.get_table_quality_checks_summary')
    def test_good_client_response(self, mock_get_table_quality_checks_summary: unittest.mock.Mock) -> None:
        ...
        mock_response_json = json.dumps(
            {'checks': {
                ...
                'msg': 'Success'})
        mock_get_table_quality_checks_summary.return_value = Response(response=mock_response_json, status=HTTPStatus.OK)
