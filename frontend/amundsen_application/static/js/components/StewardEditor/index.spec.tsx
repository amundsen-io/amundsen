...
import { StewardEditor, StewardEditorProps } from '.';
import * as Constants from './constants';

const setup = (propOverrides?: Partial<StewardEditorProps>) => {
  const props: StewardEditorProps = {
    errorText: null,
    isLoading: false,
    itemProps: {},
    isEditing: undefined,
  ...
  const wrapper = mount<StewardEditor>(<StewardEditor {...props} />);
