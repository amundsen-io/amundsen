...
from search_service.api.document import DocumentFeatureAPI


class TestDocumentFeatureAPI(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_delete(self, get_proxy: MagicMock, RequestParser: MagicMock) -> None:
        ...
        response = DocumentFeatureAPI().delete(document_id='fake id')
