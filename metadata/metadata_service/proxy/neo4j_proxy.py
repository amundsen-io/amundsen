...
from neo4j import Record, Driver, GraphDatabase  # noqa: F401
...
from metadata_service.proxy.neo4j_proxy_v2 import Neo4jProxy as NP
class Neo4jProxy(BaseProxy):
    ...
    def __init__(self, *,
        ...
        # if URI scheme not secure set `trust`` and `encrypted`
    ...
    def get_table(self, *, table_uri: str) -> Table:
        ...
        """
        return self.proxy_v2.get_table(table_uri=table_uri)
